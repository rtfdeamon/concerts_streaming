  ...
  return (
    <section className={styles.wrapper}>
        ...
        <div className={styles.contentBlock}>
            ...
            <p className={styles.text}>
              Are provided a free account but may request in writing to have their account closed. Send your request to <Link href={'digitalplatforment@gmail.com'}>digitalplatforment@gmail.com</Link> and your access will be closed and lose program access up to 3 days from the date of their written cancellation notice.
            </p>
        </div>
        <div className={styles.contentBlock}>
            <h6 className={styles.subtitle}>Artists, Directory, Services:</h6>
            <p className={styles.text}>
            Monthly payers may cancel 72 hours prior to next *billing cycle with a written notice sent to digitalplatforment@gmail.com  Any notice received less than 72 hours of next billing cycle will be billed for the next month. No refunds for cancellations as all sales are final. Monthly member payers will lose program access up to 3 days from the date of their written cancellation notice.
            </p>
            <p className={styles.text}>
        ...
        <div className={styles.contentBlock}>
            ...
            <p className={styles.text}>
            3-, 6-, or 9-month payers may cancel any time with a 30 day prior to the next *ads renewal date  written notice sent to         <Link href={'digitalplatforment@gmail.com'}>digitalplatforment@gmail.com</Link>
        ...
        <div className={styles.contentBlock}>
           ...
            Any notice received less than 30 days prior to the next ads renewal date will be billed for the next ad run period previously chosen.  No refunds for cancellations as all sales are final. Advertiser member payers will lose program access up to 3 days from the date of their written cancellation notice.            </p>
            <p className={styles.text}>
            To reactivate your account or any questions regarding your account please contact <Link href={'digitalplatforment@gmail.com'}>digitalplatforment@gmail.com</Link>
            </p>
        </div>
        <div className={styles.contentBlock}>
            ...
            Questions regarding a cancellation or refund, please contact <Link href={'digitalplatforment@gmail.com'}>digitalplatforment@gmail.com</Link> and instructions will be provided. 
            </p>
            <p className={styles.text}>
            Any policies for Digital Platform Entertainment are subject to change with or without notice at any time. 
            For questions regarding your account, refunds and or cancellations please reach out to digitalplatforment@gmail.com 
            </p>
        </div>
    </section>
  )
