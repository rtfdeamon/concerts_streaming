...
import AdvertiserPayPalBtns from './TariffAdvertiserPaypalBtns'

export default function TariffAdvertiserPaypalModal({isOpen, setIsOpen, variant} :
            ...
            <div className="flex min-h-full items-center justify-center p-6 text-center">
              ...
              >
                <Dialog.Panel className="w-full text-center max-w-md transform overflow-hidden rounded-2xl bg-white p-6 align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4">
                      <div>
                          <AdvertiserPayPalBtns variant={variant} setIsOpen={closeModal} />          
                      </div>
                  </div>
                </Dialog.Panel>
              </Transition.Child>
