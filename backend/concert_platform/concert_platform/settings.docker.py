"""
Django settings for concert_platform project.
...
SECRET_KEY = "django-insecure-6_-xx4)dl2$43_h38)_@_^5=rmgc7bjm5*b5@5($c(y2q)*yg5"
...
ROOT_URLCONF = "concert_platform.urls"
...
WSGI_APPLICATION = "concert_platform.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get('DATABASE_NAME', 'concertstreaming'),
